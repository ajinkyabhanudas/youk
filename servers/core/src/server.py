...
def apply_proposal(
    ...
    actor: who confirmed this ("founder" or "contractor"). Defaulted to "founder" —
    existing callers are unaffected. Recorded on the proposal for audit (actor extension,
    defaulted off; unrecognised values fall back to "founder" rather than erroring).
    ...
    Returns: applied, blocked, change_type, change_summary, confirmed_by, message.
    """
    try:
        return _apply_proposal(proposal_id, confirmed, safe_types, review_required_override, actor)
